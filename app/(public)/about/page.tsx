    ...
    projects: [
      ...
      },
      {
        ...
        achievements: [
          ...
          {
            tag: "운영 효율성 개선",
            text: "하드코딩으로 매번 빌드/배포가 필요했던 이벤트성 기능(특정 단어 입력 시 데코레이션)의 구조를 개선. 데이터를 JSON으로 정규화하고 실시간 수정이 가능한 사내 어드민 페이지를 기획·개발하여 수십 여 개의 단어셋 수정 업무 효율 대폭 향상",
          },
          {
            tag: "안정성 및 UX",
            text: "Playwright 기반의 E2E 테스트 환경을 도입하여 핵심 유저 동선 검증 자동화 및 릴리즈 안정성 향상",
          },
          {
            tag: "UX 고도화",
      ...
      },
      {
        ...
        achievements: [
          {
            text: "온보딩부터 홈 화면으로 이어지는 초기 진입 동선을 구현하고, 유저 인증 상태 및 다양한 예외 케이스를 안전하게 처리하는 리다이렉트 로직 설계",
          },
          {
      ...
      },
      {
        ...
        achievements: [
          {
            text: "카카오톡의 특수한 말풍선 형태를 웹 환경에서 정확히 렌더링하도록 누락 기능 구현 및 다양한 말풍선 타입에 대한 테스트 코드 작성",
          },
          {
